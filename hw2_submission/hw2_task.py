...
#   for generation.
#
# Measured on NVIDIA L40S:
# - Slow baseline: 1.62s for 128 tokens (78.8 tok/s)
# - Optimized: 0.27s for 128 tokens (468.8 tok/s)
# - Speedup: 5.95x
#
...
# forward passes. The profile also shows much less CUDA time in the optimized
# run because decode no longer repeats the expensive full-prefix work.
#
